...
namespace PuertsMcp.Editor
{
    ...
    public class McpServerWindow : EditorWindow
    {
        ...
        private const string PrefKeyAutoStart = "PuertsMcp_AutoStart";
        ...
        private static void OnDomainLoaded()
        {
            ...
            bool shouldAutoStart = SessionState.GetBool(SessionKeyWasRunning, false) || EditorPrefs.GetBool(PrefKeyAutoStart, true);
            if (shouldAutoStart)
            {
